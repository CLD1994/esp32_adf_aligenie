...
#define FIRMWARE_VERSION   "0.0.0-I-19700101.0000"
#endif
 ...
 */
extern int ag_os_get_firmware_version(char *);
 ...
 */
extern int ag_os_flash_read(const char * const key, const char * outval, size_t len);
...
extern int ag_os_flash_read_integer(const char * const key, int *outval);
extern int ag_os_flash_write_integer(const char * const key, int outval);
...
extern int ag_os_get_mac_address_raw(char * mac);
